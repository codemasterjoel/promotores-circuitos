                                ...
                                <div class="grid grid-cols-3 gap-4"> 
                                    <div class="flex items-center justify-center py-4"> {{-- campo cedula --}}
                                        <div class="w-full rounded-lg bg-gray-500">
                                            <div class="flex">
                                                <input wire:model="cedula" type="number"  class=" bg-white pl-2 text-base border font-semibold outline-0 rounded-tl-lg rounded-bl-lg border-slate-200">
                                                <input type="button" wire:click="" value="Consultar" class="bg-gradient-primary p-2 rounded-tr-lg rounded-br-lg text-white font-semibold transition-colors">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="flex items-center justify-center pb-4"> {{-- campo Telefono --}}
                                            <div class="w-full rounded-lg bg-gray-500">
                                                <div class="flex">
                                                    ...
                                                    <input wire:model="telefono" type="text" class="w-full bg-white pl-2 border text-base font-semibold outline-0 border-slate-200" minlength="15" placeholder="(0000) 000-0000" onkeypress="$(this).mask('(0000) 000-0000')" title="SOLO SE PERMITE NUMEROS, 11 DIGITOS" />
                                                    <input wire:click="guardarPromotor" type="button" value="Guardar" class="bg-gradient-to-r from-cyan-400 to-cyan-600 p-2 rounded-tr-lg rounded-br-lg text-white font-semibold transition-colors">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td class="ps-4"><p class="text-xs font-weight-bold mb-0"><?php echo $indice; ?></p></td>
                                            ...
                                            <td class="text-center text-uppercase"><p class="text-xs font-weight-bold mb-0"></p>{{$promotor->nombre_completo}}</td>
                                            ...
                                            @if (auth()->user()->nivel_id == 1)
                                                <td class="text-center"><a href="#" class="mx-3" data-bs-toggle="tooltip" data-bs-original-title="Editar Promotor">
                                                    ...
                                                    <a href="#" wire:click="borrarPromotor('{{$promotor->id}}')" class=" text-danger font-bold py-2 px-4"><span class="material-symbols-outlined">person_cancel</span></a>
                                                </td>
                                            @endif
                                        </tr>
                                        @endforeach
